...
System.register(["../models/ListaNegociacoes", "../models/Mensagem", "../views/MensagemView", "../views/NegociacoesView", "../services/NegociacaoService", "../helpers/DateHelper", "../helpers/Bind", "../models/Negociacao"], function (_export, _context) {
  ...
  var ListaNegociacoes, Mensagem, MensagemView, NegociacoesView, NegociacaoService, DateHelper, Bind, Negociacao, _createClass, NegociacaoController, negociacaoController;
    ...
    execute: function () {
      ...
      NegociacaoController = function () {
        function NegociacaoController() {
          ...
          // tudo que é atributo de classe no constructor

          var $ = document.querySelector.bind(document); //bind mantem associacao com document
